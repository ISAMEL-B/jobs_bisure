    ...
    <div id="g-page-surround">
        ...
        <header id="g-header">
            <div class="g-container">
                <div class="g-grid" style="align-items:center; justify-content:space-between;">

                    <!-- LOGO -->
                    <div class="g-block size-16 center">
                        <div id="jllogo-7675-particle" class="g-content g-particle">
                            <a class="jl-logo" href="/jobaggregator/index.php" title="bisure Jobs" rel="home">
                                <img src="bisure-jobs-logo.png"
                                    alt="bisure Jobs"
                    ...
                    <!-- ADMIN INFO -->
                    <div class="g-block hidden-phone" style="flex:1; text-align:right;">
                        <span style="
                            font-weight:600;
                            color:var(--dark);
                            font-size:14px;
                        ...
                        ">
                            ...
                            <?= htmlspecialchars($adminName ?? 'Administrator') ?>
                        </span>
                    </div>
        ...
        <section id="g-navigation" class="nopaddingall nomargintop">
            <div class="g-container">
                ...
                <div class="g-grid">
                    ...
                    <!-- DESKTOP NAVIGATION -->
                    <div class="g-block size-100 align-left hidden-phone">

                        <div id="menu-5263-particle" class="g-content g-particle">
                                                ...
                                                <div id="js-jobs-wrapper">
                                                    ...
                                                    <div class="js-bottomrow">
                                                        ...
                                                        <div class="js-col-xs-12 js-col-md-4 js-actions">
                                                            ...
                                                            <a class="js-button js-btn-apply" href="<?= htmlspecialchars($job['apply_url']) ?>" target="_blank"><i class="bi bi-eye"></i> View Details & Apply</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
