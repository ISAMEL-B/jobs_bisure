    ...
    <div id="g-page-surround">
        ...
        <div class="mobile-menu-panel" id="mobileMenuPanel">
            ...
            <ul class="mobile-menu-items">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/manage/users">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/send_emails">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/manage/subscribe">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/manage/jobs">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/manage/categories">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/manage/settings">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/mailing/password_recovery">
                ...
                <li class="g-menu-item">
                    <a class="g-menu-item-container"
                    href="/jobaggregator/security/logout">
