...
<head>
    ...
    <title>Subscriber Management - BISure Jobs</title>
...
<body>
            ...
            <div class="g-grid">
                ...
                <div class="g-block hidden-phone">
                    <span style="font-weight:600;">
                        <i class="bi bi-person-circle"></i> <?= htmlspecialchars($_SESSION['full_name'] ?? 'Administrator') ?>
                    </span>
                </div>
            ...
            <div class="g-grid">
                <div class="g-block size-100">
                    <nav class="g-main-nav">
                        <ul class="g-toplevel">
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/index.php"><i class="bi bi-speedometer2"></i> DASHBOARD</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/manage/users.php"><i class="bi bi-person-badge-fill"></i> SYSTEM USERS</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/send_emails.php"><i class="bi bi-envelope-paper"></i> SEND EMAILS</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/manage/subscribe.php"><i class="bi bi-people"></i> SUBSCRIBERS</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/manage/jobs.php"><i class="bi bi-briefcase"></i> MANAGE JOBS</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/manage/categories.php"><i class="bi bi-folder"></i> CATEGORIES</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/manage/settings.php"><i class="bi bi-gear"></i> SETTINGS</a></li>
                            <li class="g-menu-item"><a class="g-menu-item-container" href="/jobaggregator/security/logout.php"><i class="bi bi-box-arrow-right"></i> LOGOUT</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <div class="mobile-menu-panel" id="mobileMenuPanel">
        <div class="mobile-menu-header">
            <h3><i class="bi bi-grid"></i> Menu</h3>
